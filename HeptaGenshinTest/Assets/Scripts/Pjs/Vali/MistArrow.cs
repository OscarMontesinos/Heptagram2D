...
public class MistArrow : Projectile
{
    PjBase user;
    ...
    public void SetUp(PjBase user, float speed, float range, float dmg, float stunTime, float arrowDetour, float arrowBounceRange, float arrowSpeed, float arrowRange, float arrowDmg)
    {
        this.user = user;
        this.speed = speed;
        this.range = range;
